      ...
      fields: [
        {
          ...
          label: 'Address',
          required: true,
          defaultValue: 'Your Institute Name\nYour Street Address\nYour City, Your State — Postal Code',
          admin: {
        ...
        },
        {
          ...
          admin: {
            description: 'WhatsApp number in format: 1234567890 (no + or spaces)',
          },
        },
        {
          ...
          defaultValue: 'Hi, I want to know more about admissions.',
          admin: {
        ...
        },
        {
          ...
          label: 'Primary Email',
          required: true,
          defaultValue: 'info@yourdomain.com',
        },
        {
          name: 'secondaryEmail',
          type: 'email',
      ...
      fields: [
        {
          ...
          required: true,
          defaultValue: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3024.2219901290355!2d-74.00369368400567!3d40.71312937933155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25a316b4b2b5d%3A0x5e8f8e9f51fc6b!2sNew%20York%2C%20NY!5e0!3m2!1sen!2sus!4v1234567890',
          admin: {
    ...
    // Business Hours
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'text',
          label: 'Closed On',
          defaultValue: 'Weekends & Public Holidays',
        },
      ],
    },
      ...
      fields: [
        {
          ...
          defaultValue: 'Leading educational consultancy offering admission guidance for Nursing, Engineering, Pharmacy, MBA and more. Expert career counselling for students.',
          admin: {
      ...
      fields: [
        {
          ...
          defaultValue: '© 2026 Your Institute Name. All rights reserved.',
          admin: {
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'EduConsult Pro | Educational Consultancy Services',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
              label: 'Meta Description',
              defaultValue: 'Leading educational consultancy offering admission guidance for Nursing, Engineering, Pharmacy, MBA and more.',
            },
          ],
        },
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'About Us | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
              label: 'Meta Description',
              defaultValue: 'Learn about our mission, vision, and commitment to helping students achieve their educational goals.',
            },
            {
              name: 'headerTitle',
              type: 'text',
            ...
            },
            {
              ...
              defaultValue: 'Your trusted partner in education',
            },
          ],
        },
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'Explore All Programs | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'Our Services | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'Admission Process | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'Student Corner | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'Blog | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
          ...
          fields: [
            {
              ...
              type: 'text',
              label: 'Meta Title',
              defaultValue: 'Contact Us | EduConsult Pro',
            },
            {
              name: 'metaDescription',
              type: 'textarea',
              label: 'Meta Description',
              defaultValue: 'Get in touch with us for admission enquiries, career counselling, and educational guidance.',
            },
            {
              name: 'headerTitle',
              type: 'text',
